...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/home/mwaki/Documents/Vscode/data-science-learning-roadmap/Month_1/Week_2/env/bin/python",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/croot/contourpy_1732540045555/work/.mesonpy-qp3vt5ge/lib/contourpy/util",
        source_dir=r"/croot/contourpy_1732540045555/work/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/croot/contourpy_1732540045555/work/.mesonpy-qp3vt5ge/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
